    ...
    protected void init() {
        ...
        try {
            ...
            for (java.lang.reflect.Method m : EditBox.class.getMethods()) {
                if (m.getName().equals("setFormatter") || m.getName().equals("setRenderTextProvider") || m.getName().equals("addFormatter")) {
                    if (m.getParameterCount() == 1 && m.getParameterTypes()[0].isInterface()) {
                        ...
                        m.invoke(this.apiKeyBox, java.lang.reflect.Proxy.newProxyInstance(
                            ...
                            (proxy, method, args) -> {
                                if (method.getName().equals("format") || method.getName().equals("apply") || method.getName().equals("applyAsCharSequence") || method.getName().equals("provide")) {
